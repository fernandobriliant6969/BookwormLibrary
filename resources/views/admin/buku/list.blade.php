...
@push('styles')
    ...
    <style>
        /* Untuk menyembunyikan scrollbar pada menu ringkasan */
        .ringkasan {
            overflow: hidden;
                                ...
                                <div class="card h-100 shadow-lg border-0">
                                    ...
                                    <div class="card-body p-2 d-flex flex-column justify-content-between">
                                        ...
                                        <div class="mt-1 border-top d-flex align-items-center" style="font-size: 0.8rem;">
                                            ...
                                            <span class="text-muted pt-2" style="font-size: 0.7rem;">{{ number_format($buku->rating_avg, 1) ?? '0.0' }} ({{ $buku->review_count ?? '0' }})</span>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <form action="{{ route('review.store', $buku->idBuku) }}" method="POST" onsubmit="tampilLoadingAnimation(this)">
                                                                        ...
                                                                        <div class="row g-3">
                                                                            ...
                                                                            <div class="col-12 col-md-4 border-end-md border-secondary border-opacity-25 text-center text-md-start pt-2">
                                                                                ...
                                                                                <div class="rater-stars-create mx-auto mx-md-0" data-id="{{ $buku->idBuku }}"></div>
